...
@EqualsAndHashCode
@NoArgsConstructor
public class VehiclePz implements Serializable {
    private String name;

    private VehiclePz(String name) {
    ...
    public static VehiclePz create(String name) {
        return new VehiclePz(name);
    }

    public VehiclePz changeTypeName(String name) {
        return create(name);
    }
